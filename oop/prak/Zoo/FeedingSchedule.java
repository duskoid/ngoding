public class FeedingSchedule<T extends Animal> {
    ...
    public void showSchedule(){
        System.out.println(animal.getName() + " diberi makan " + getFeedingTimes() + " kali per hari");
    }
    ...
    public void increaseFeedingTimes(){
        feedingTimes++;
        System.out.println("Jadwal makan " + animal.getName() + " ditambah menjadi " + getFeedingTimes() + " kali per hari");
    }
