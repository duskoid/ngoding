public class Item {
  ...
  public void setDiscount(double discount) throws InvalidDiscountException {
    if (discount > 99 || discount < 1) throw new InvalidDiscountException("Diskon harus antara 0-100%.");
  ...
  public void reduceStock(int quantity) throws InvalidQuantityException, OutOfStockException {
    ...
    if (stock < quantity) throw new OutOfStockException("Stok tidak mencukupi. Tersedia: " + stock + ", Diminta: " + quantity);
    stock -= quantity;
  }
