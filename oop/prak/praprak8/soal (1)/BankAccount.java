public class BankAccount {
    ...
    public BankAccount(String owner, double balance) throws InvalidAmountException {
        // Type your code
        if (balance < 0) throw new InvalidAmountException("Saldo awal tidak boleh negatif.");
        this.owner = owner;
    ...
    public void deposit(double amount) throws InvalidAmountException {
        // Type your code
        if (amount < 0) throw new InvalidAmountException("Nominal deposit tidak boleh negatif.");
        balance += amount;
    }
    ...
    public void withdraw(double amount)
        ...
        // Type your code
        if (amount < 0) throw new InvalidAmountException("Nominal penarikan tidak boleh negatif.");
        if (getBalance() < amount) throw new InsufficientBalanceException("Saldo tidak mencukupi untuk penarikan.");
        balance -= amount;
    }
    ...
    public String toString() {
        // Type your code
        return String.format("%s - Saldo: Rp%.01f", getOwner(), getBalance());
    }
}
